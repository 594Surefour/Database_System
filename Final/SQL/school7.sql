...
-- Records of 学院
-- ----------------------------
INSERT INTO `学院` VALUES ('XYBH001', '信息学部', '杨添程');
INSERT INTO `学院` VALUES ('XYBH002', '教育学部', '李泽浩');
INSERT INTO `学院` VALUES ('XYBH003', '心理与认知科学学院', '董小尧');
...
-- Records of 开设课程
-- ----------------------------
INSERT INTO `开设课程` VALUES ('KCBH001', '数据库', '专业必修', '2022-01-12', '教学楼', '2021-06-01 00:00:00', '2021-06-15 00:00:00', '30.00');
INSERT INTO `开设课程` VALUES ('KCBH002', '编译原理', '专业必修', '2022-01-13', '教学楼', '2021-06-01 00:00:00', '2021-06-15 00:00:00', '30.00');
INSERT INTO `开设课程` VALUES ('KCBH003', '数据挖掘', '专业选修', '2022-01-14', '教学楼', '2021-06-01 00:00:00', '2021-06-15 00:00:00', '30.00');
INSERT INTO `开设课程` VALUES ('KCBH004', '操作系统', '专业必修', '2022-01-15', '教学楼', '2021-06-01 00:00:00', '2021-06-15 00:00:00', '30.00');
INSERT INTO `开设课程` VALUES ('KCBH005', '计算机导论', '专业必修', '2022-01-16', '教学楼', '2021-06-01 00:00:00', '2021-06-15 00:00:00', '30.00');
INSERT INTO `开设课程` VALUES ('KCBH006', '临床心理学', '专业选修', '2022-01-17', '教学楼', '2021-06-01 00:00:00', '2021-06-15 00:00:00', '30.00');
INSERT INTO `开设课程` VALUES ('KCBH007', '发展心理学', '专业必修', '2022-01-18', '教学楼', '2021-06-01 00:00:00', '2021-06-15 00:00:00', '30.00');
INSERT INTO `开设课程` VALUES ('KCBH009', '教育导论', '专业必修', '2022-01-19', '教学楼', '2021-06-01 00:00:00', '2021-06-15 00:00:00', '30.00');
...
-- Records of 教师
-- ----------------------------
INSERT INTO `教师` VALUES ('JSBH001', 'XYBH001', '田欣怡', '女', '120345913@qq.com', '18532194354', '12000.00', '1966-01-01', '12345');
INSERT INTO `教师` VALUES ('JSBH002', 'XYBH001', '沈海燕', '女', '120345914@qq.com', '18532194355', '9000.00', '1966-01-02', '12345');
INSERT INTO `教师` VALUES ('JSBH003', 'XYBH001', '毛学真', '男', '120345915@qq.com', '18532194356', '15000.00', '1966-01-03', '12345');
INSERT INTO `教师` VALUES ('JSBH004', 'XYBH001', '宋宏博', '男', '120345916@qq.com', '18532194357', '8000.00', '1966-01-04', '12345');
INSERT INTO `教师` VALUES ('JSBH005', 'XYBH002', '武兴学', '男', '120345917@qq.com', '18532194358', '20000.00', '1966-01-05', '12345');
INSERT INTO `教师` VALUES ('JSBH006', 'XYBH002', '常可可', '女', '120345918@qq.com', '18532194359', '12000.00', '1966-01-06', '12345');
INSERT INTO `教师` VALUES ('JSBH007', 'XYBH003', '谭乐水', '男', '120345919@qq.com', '18532194360', '9000.00', '1966-01-07', '12345');
INSERT INTO `教师` VALUES ('JSBH008', 'XYBH003', '叶芹悦', '女', '120345920@qq.com', '18532194361', '16000.00', '1966-01-08', '12345');
...
-- Records of 课程
-- ----------------------------
INSERT INTO `课程` VALUES ('KCBH001', 'JSBH001', '数据库', '上机', '2.00', '专业必修');
INSERT INTO `课程` VALUES ('KCBH002', 'JSBH002', '编译原理', '上机', '3.00', '专业必修');
INSERT INTO `课程` VALUES ('KCBH003', 'JSBH003', '数据挖掘', '项目', '2.00', '专业选修');
INSERT INTO `课程` VALUES ('KCBH004', 'JSBH004', '操作系统', '闭卷', '2.00', '专业必修');
INSERT INTO `课程` VALUES ('KCBH005', 'JSBH004', '计算机导论', '项目', '1.50', '专业必修');
INSERT INTO `课程` VALUES ('KCBH006', 'JSBH005', '临床心理学', '论文', '2.00', '专业选修');
INSERT INTO `课程` VALUES ('KCBH007', 'JSBH006', '发展心理学', '论文', '1.00', '专业必修');
INSERT INTO `课程` VALUES ('KCBH008', 'JSBH005', '异常心理学', '论文', '2.00', '专业必修');
INSERT INTO `课程` VALUES ('KCBH009', 'JSBH008', '教育导论', '开卷', '3.00', '专业必修');
INSERT INTO `课程` VALUES ('KCBH010', 'JSBH007', '教育心理学', '论文', '2.00', '专业选修');
...
-- ----------------------------
-- View structure for 一班学生名单
-- ----------------------------
DROP VIEW IF EXISTS `一班学生名单`;
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `一班学生名单` AS select `学生`.`学号` AS `学号`,`学生`.`姓名` AS `姓名`,`学生`.`性别` AS `性别`,`学生`.`生日` AS `生日`,`学生`.`电话` AS `电话` from `学生` where (`学生`.`班级编号` = 'BJBH001') ;

-- ----------------------------
-- View structure for 三班学生名单
-- ----------------------------
DROP VIEW IF EXISTS `三班学生名单`;
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `三班学生名单` AS select `学生`.`学号` AS `学号`,`学生`.`姓名` AS `姓名`,`学生`.`性别` AS `性别`,`学生`.`生日` AS `生日`,`学生`.`电话` AS `电话` from `学生` where (`学生`.`班级编号` = 'BJBH003') ;
...
-- ----------------------------
-- View structure for 二班学生名单
-- ----------------------------
DROP VIEW IF EXISTS `二班学生名单`;
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `二班学生名单` AS select `学生`.`学号` AS `学号`,`学生`.`姓名` AS `姓名`,`学生`.`性别` AS `性别`,`学生`.`生日` AS `生日`,`学生`.`电话` AS `电话` from `学生` where (`学生`.`班级编号` = 'BJBH002') ;

-- ----------------------------
-- View structure for 五班学生名单
-- ----------------------------
DROP VIEW IF EXISTS `五班学生名单`;
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `五班学生名单` AS select `学生`.`学号` AS `学号`,`学生`.`姓名` AS `姓名`,`学生`.`性别` AS `性别`,`学生`.`生日` AS `生日`,`学生`.`电话` AS `电话` from `学生` where (`学生`.`班级编号` = 'BJBH005') ;
...
-- ----------------------------
-- View structure for 四班学生名单
-- ----------------------------
DROP VIEW IF EXISTS `四班学生名单`;
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `四班学生名单` AS select `学生`.`学号` AS `学号`,`学生`.`姓名` AS `姓名`,`学生`.`性别` AS `性别`,`学生`.`生日` AS `生日`,`学生`.`电话` AS `电话` from `学生` where (`学生`.`班级编号` = 'BJBH004') ;
...
CREATE TRIGGER `xuanke_up` BEFORE UPDATE ON `选课` FOR EACH ROW BEGIN
	...
	FROM 选课
	WHERE 选课.学号 = new.学号 and `选课`.`开课编号`=new.课程编号;
	SET zho = final+rest;
	SET zho = rest+ final;
...
CREATE TRIGGER `xuanke_del` BEFORE DELETE ON `选课` FOR EACH ROW BEGIN
 ...
 SELECT 所投意愿值 INTO final
 FROM 选课
 WHERE 选课.学号 = OLD.学号 and `选课`.`课程编号`=OLD.课程编号;
