...
CREATE TABLE `住宿` (
  ...
  PRIMARY KEY (`宿舍编号`,`学号`),
  KEY `学号` (`学号`),
  CONSTRAINT `住宿_ibfk_1` FOREIGN KEY (`学号`) REFERENCES `学生` (`学号`) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `可借图书` (
  ...
  KEY `学号` (`学号`),
  CONSTRAINT `可借图书_ibfk_1` FOREIGN KEY (`可借书籍编号`) REFERENCES `书籍` (`书籍编号`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `可借图书_ibfk_2` FOREIGN KEY (`学号`) REFERENCES `学生` (`学号`) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
-- ----------------------------
BEGIN;
INSERT INTO `可借图书` VALUES ('SJBH001', 'KJFBBH001', 'XH001', '2021-02-02', '2021-03-02', 0.000);
INSERT INTO `可借图书` VALUES ('SJBH001', 'KJFBBH002', 'XH002', '2021-02-03', '2021-03-03', 0.000);
INSERT INTO `可借图书` VALUES ('SJBH002', 'KJFBBH003', 'XH003', '2021-02-04', '2021-03-04', 0.000);
INSERT INTO `可借图书` VALUES ('SJBH002', 'KJFBBH004', 'XH004', '2021-02-05', '2021-03-05', 0.000);
INSERT INTO `可借图书` VALUES ('SJBH002', 'KJFBBH005', 'XH005', '2021-02-06', '2021-03-06', 0.000);
INSERT INTO `可借图书` VALUES ('SJBH003', 'KJFBBH001', 'XH006', '2021-02-07', '2021-03-07', 0.000);
INSERT INTO `可借图书` VALUES ('SJBH004', 'KJFBBH003', 'XH007', '2021-02-08', '2021-03-08', 0.000);
COMMIT;
...
CREATE TABLE `学生` (
  `学号` varchar(15) NOT NULL,
  `密码` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '123',
...
-- ----------------------------
BEGIN;
INSERT INTO `学生` VALUES ('XH001', '123456', '男', '文景胜', '2020-01-01', '13733871170', 'BJBH001', 90);
INSERT INTO `学生` VALUES ('XH002', '123456', '男', '程子民', '2020-01-02', '13733871171', 'BJBH001', 90);
INSERT INTO `学生` VALUES ('XH003', '123456', '男', '黎康乐', '2020-01-03', '13733871172', 'BJBH001', 90);
INSERT INTO `学生` VALUES ('XH004', '123456', '女', '宁妙竹', '2020-01-04', '13733871173', 'BJBH001', 90);
INSERT INTO `学生` VALUES ('XH005', '123456', '女', '利凡梅', '2020-01-05', '13733871174', 'BJBH001', 90);
INSERT INTO `学生` VALUES ('XH006', '123456', '女', '蒙小星', '2020-01-06', '13733871175', 'BJBH001', 90);
INSERT INTO `学生` VALUES ('XH007', '123456', '女', '邹天玉', '2020-01-07', '13733871176', 'BJBH002', 90);
INSERT INTO `学生` VALUES ('XH008', '123456', '女', '瞿苒苒', '2020-01-08', '13733871177', 'BJBH002', 90);
INSERT INTO `学生` VALUES ('XH009', '123456', '女', '朱新梅', '2020-01-09', '13733871178', 'BJBH002', 90);
INSERT INTO `学生` VALUES ('XH010', '123456', '男', '戈星华', '2020-01-10', '13733871179', 'BJBH002', 90);
INSERT INTO `学生` VALUES ('XH011', '123456', '男', '吴丰羽', '2020-01-11', '13733871180', 'BJBH002', 90);
INSERT INTO `学生` VALUES ('XH012', '123456', '男', '贾泰宁', '2020-01-12', '13733871181', 'BJBH002', 90);
INSERT INTO `学生` VALUES ('XH013', '123456', '男', '卢成济', '2020-01-13', '13733871182', 'BJBH003', 90);
INSERT INTO `学生` VALUES ('XH014', '123456', '男', '简子实', '2020-01-14', '13733871183', 'BJBH003', 90);
INSERT INTO `学生` VALUES ('XH015', '123456', '男', '弘英杰', '2020-01-15', '13733871184', 'BJBH003', 90);
INSERT INTO `学生` VALUES ('XH016', '123456', '男', '黄和泰', '2020-01-16', '13733871185', 'BJBH003', 90);
INSERT INTO `学生` VALUES ('XH017', '123456', '女', '向元瑶', '2020-01-17', '13733871186', 'BJBH003', 90);
INSERT INTO `学生` VALUES ('XH018', '123456', '女', '刘如雪', '2020-01-18', '13733871187', 'BJBH003', 90);
INSERT INTO `学生` VALUES ('XH019', '123456', '女', '相芸英', '2020-01-19', '13733871188', 'BJBH003', 90);
INSERT INTO `学生` VALUES ('XH020', '123456', '女', '甘正清', '2020-01-20', '13733871189', 'BJBH003', 90);
INSERT INTO `学生` VALUES ('XH021', '123456', '女', '蔡姗姗', '2020-01-21', '13733871190', 'BJBH004', 90);
INSERT INTO `学生` VALUES ('XH022', '123456', '女', '毛雨彤', '2020-01-22', '13733871191', 'BJBH004', 90);
INSERT INTO `学生` VALUES ('XH023', '123456', '女', '董秀秀', '2020-01-23', '13733871192', 'BJBH004', 90);
INSERT INTO `学生` VALUES ('XH024', '123456', '女', '丁水琼', '2020-01-24', '13733871193', 'BJBH004', 90);
INSERT INTO `学生` VALUES ('XH025', '123456', '男', '董飞翔', '2020-01-25', '13733871194', 'BJBH004', 90);
INSERT INTO `学生` VALUES ('XH026', '123456', '男', '张开朗', '2020-01-26', '13733871195', 'BJBH004', 90);
INSERT INTO `学生` VALUES ('XH027', '123456', '男', '万阳炎', '2020-01-27', '13733871196', 'BJBH004', 90);
INSERT INTO `学生` VALUES ('XH028', '123456', '男', '罗伟兆', '2020-01-28', '13733871197', 'BJBH004', 90);
INSERT INTO `学生` VALUES ('XH029', '123456', '男', '田元忠', '2020-01-29', '13733871198', 'BJBH005', 90);
INSERT INTO `学生` VALUES ('XH030', '123456', '男', '白宏放', '2020-01-30', '13733871199', 'BJBH005', 90);
INSERT INTO `学生` VALUES ('XH031', '123456', '男', '吴鸿波', '2020-01-31', '13733871200', 'BJBH005', 90);
INSERT INTO `学生` VALUES ('XH032', '123456', '女', '段玉珂', '2020-02-01', '13733871201', 'BJBH005', 90);
INSERT INTO `学生` VALUES ('XH033', '123456', '女', '石燕平', '2020-02-02', '13733871202', 'BJBH005', 90);
INSERT INTO `学生` VALUES ('XH034', '123456', '女', '叶沛文', '2020-02-03', '13733871203', 'BJBH005', 90);
COMMIT;
...
CREATE TABLE `开设课程` (
  ...
  KEY `课程编号` (`课程编号`),
  CONSTRAINT `开设课程_ibfk_1` FOREIGN KEY (`课程编号`) REFERENCES `课程` (`课程编号`) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `教学` (
  ...
  KEY `课程编号` (`课程编号`),
  CONSTRAINT `教学_ibfk_1` FOREIGN KEY (`教师编号`) REFERENCES `教师` (`教师编号`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `教学_ibfk_2` FOREIGN KEY (`课程编号`) REFERENCES `课程` (`课程编号`) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `教师` (
  ...
  PRIMARY KEY (`教师编号`),
  KEY `学院编号` (`学院编号`),
  CONSTRAINT `教师_ibfk_1` FOREIGN KEY (`学院编号`) REFERENCES `学院` (`学院编号`) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `班级` (
  ...
  KEY `专业编号` (`专业编号`),
  KEY `班长学号` (`班长学号`),
  CONSTRAINT `班级_ibfk_1` FOREIGN KEY (`班长学号`) REFERENCES `学生` (`学号`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `班级_ibfk_2` FOREIGN KEY (`专业编号`) REFERENCES `专业` (`专业编号`) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `选课` (
  ...
  PRIMARY KEY (`学号`,`开课编号`),
  KEY `开课编号` (`开课编号`),
  CONSTRAINT `选课_ibfk_1` FOREIGN KEY (`学号`) REFERENCES `学生` (`学号`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `选课_ibfk_2` FOREIGN KEY (`开课编号`) REFERENCES `开设课程` (`课程编号`) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
-- ----------------------------
BEGIN;
INSERT INTO `选课` VALUES ('10185102204', 'KCBH001', 10);
...
CREATE ALGORITHM = UNDEFINED SQL SECURITY DEFINER VIEW `专业及学院` AS select `专业`.`专业名称` AS `专业名称`,`学院`.`学院名称` AS `学院名称`,`学院`.`院长` AS `院长` from (`专业` join `学院`) where (`专业`.`学院编号` = `学院`.`学院编号`);

-- ----------------------------
-- View structure for 信息学部教师名单
-- ----------------------------
DROP VIEW IF EXISTS `信息学部教师名单`;
CREATE ALGORITHM = UNDEFINED SQL SECURITY DEFINER VIEW `信息学部教师名单` AS select `教师`.`教师编号` AS `教师编号`,`教师`.`教师姓名` AS `教师姓名`,`教师`.`性别` AS `性别`,`教师`.`邮箱` AS `邮箱`,`教师`.`生日` AS `生日` from `教师` where (`教师`.`学院编号` = 'XYBH001');

-- ----------------------------
-- View structure for 全校学生名单
-- ----------------------------
DROP VIEW IF EXISTS `全校学生名单`;
CREATE ALGORITHM = UNDEFINED SQL SECURITY DEFINER VIEW `全校学生名单` AS select `学生`.`学号` AS `学号`,`学生`.`姓名` AS `姓名`,`学生`.`性别` AS `性别`,`学生`.`生日` AS `生日`,`学生`.`电话` AS `电话` from `学生` order by `学生`.`学号`;

-- ----------------------------
-- View structure for 心理与认知科学学院教师名单
-- ----------------------------
DROP VIEW IF EXISTS `心理与认知科学学院教师名单`;
CREATE ALGORITHM = UNDEFINED SQL SECURITY DEFINER VIEW `心理与认知科学学院教师名单` AS select `教师`.`教师编号` AS `教师编号`,`教师`.`教师姓名` AS `教师姓名`,`教师`.`性别` AS `性别`,`教师`.`邮箱` AS `邮箱`,`教师`.`生日` AS `生日` from `教师` where (`教师`.`学院编号` = 'XYBH003');

-- ----------------------------
-- View structure for 教育学部教师名单
-- ----------------------------
DROP VIEW IF EXISTS `教育学部教师名单`;
CREATE ALGORITHM = UNDEFINED SQL SECURITY DEFINER VIEW `教育学部教师名单` AS select `教师`.`教师编号` AS `教师编号`,`教师`.`教师姓名` AS `教师姓名`,`教师`.`性别` AS `性别`,`教师`.`邮箱` AS `邮箱`,`教师`.`生日` AS `生日` from `教师` where (`教师`.`学院编号` = 'XYBH002');
...
-- ----------------------------
-- Triggers structure for table 可借图书
-- ----------------------------
...
-- ----------------------------
-- Triggers structure for table 选课
-- ----------------------------
