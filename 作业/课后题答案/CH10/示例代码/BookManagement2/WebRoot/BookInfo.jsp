...
<html>
  ...
  <center>
  	<%
		...
		String sql="select tb_bookinfo.bookcode,tb_bookinfo.isbn,tb_book.bookname,tb_book.bookauthor,tb_book.bookpublisher,tb_book.publishdate,tb_bookinfo.status from tb_book,tb_bookinfo where tb_book.isbn=tb_bookinfo.isbn";
		if(con!=null){
  	...
  	%>
  	<br><br>
  	<a href="BookInfoAdd.jsp">添加图书馆藏信息</a><br><br>
