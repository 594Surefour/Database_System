...
class StartPage:
    def __init__(self, parent_window):
        ...
        label = Label(self.window, text="学生信息管理系统", font=("Verdana", 20),bg="pink")
        ...
        Button(self.window, text="管理员登陆", font=tkFont.Font(size=16), command=lambda: AdminPage(self.window), width=30,
               height=2,
               fg='white', bg='pink', activebackground='white', activeforeground='purple').pack()
        Button(self.window, text="学生登陆", font=tkFont.Font(size=16), command=lambda: StudentPage(self.window), width=30,
               height=2, fg='white', bg='pink', activebackground='white', activeforeground='purple').pack()
...
class AdminPage:
    def __init__(self, parent_window):
        ...
        label = tk.Label(self.window, text='管理员登陆', bg='pink', font=('Verdana', 20), width=30, height=2)
        label.pack()
    ...
    def login(self):
        ...
        # 数据库操作 查询管理员表
        db = pymysql.connect(host="localhost", port=3306, user="root", password="root", database="student")  # 打开数据库连接
...
class AdminManage:
    def __init__(self, parent_window):
        ...
        # 表格的标题
        self.tree.column("ID", width=150, anchor='center')  # 表示列,不显示
        self.tree.column("姓名", width=150, anchor='center')
        self.tree.column("学号", width=100, anchor='center')
        self.tree.column("籍贯", width=100, anchor='center')
        ...
        self.age = []
        # 打开数据库连接
        db = pymysql.connect(host="localhost", port=3306, user="root", password="root", database="student")
        cursor = db.cursor()  # 使用cursor()方法获取操作游标
        ...
        # 学号
        self.right_top_id_label = Label(self.frame_left_top, text="ID：", font=('Verdana', 15))
        ...
        # 性别
        self.right_top_gender_label = Label(self.frame_left_top, text="学号：", font=('Verdana', 15))
        ...
        # 年龄
        self.right_top_gender_label = Label(self.frame_left_top, text="籍贯：", font=('Verdana', 15))
...
class AboutPage:
    def __init__(self, parent_window):
        ...
        label = tk.Label(self.window, text='学生信息管理系统', bg='pink', font=('Verdana', 20), width=30, height=2)
        label.pack()

        Label(self.window, text='谢欣霓', font=('Verdana', 18)).pack(pady=30)
        Label(self.window, text='1831050386', font=('Verdana', 18)).pack(pady=5)
        Label(self.window, text='信息学院电子商务专业', font=('Verdana', 18)).pack(pady=30)
        Label(self.window, text='一个集美貌与才华与一身的女子', font=('Verdana', 18)).pack(pady=30)
